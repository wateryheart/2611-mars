...
public class SyscallGameGetHitPoint extends AbstractSyscall
{

    public SyscallGameGetHitPoint()
    {
        super(118, "Get Hit Point");
    }
    ...
    public void simulate(ProgramStatement statement) throws ProcessingException
    {
        ...
        RegisterFile.updateRegister(2, ele.getHitPoint());
    }
}
